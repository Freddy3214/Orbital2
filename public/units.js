...
export const FLEET = {
  ...
  smallTransport:{name:"Kleiner Transporter",power:8,cargo:2500,level:2,cost:{metal:450,crystal:220,tritium:60}},
  mediumTransport:{name:"Mittlerer Transporter",power:25,cargo:10000,level:4,cost:{metal:1800,crystal:900,tritium:250}},
  largeTransport:{name:"Großer Transporter",power:70,cargo:40000,level:6,cost:{metal:7200,crystal:3600,tritium:1000}},
  frigate:{name:"Fregatte",power:180,cargo:400,level:3,cost:{metal:1200,crystal:650,tritium:300}},
  cruiser:{name:"Kreuzer",power:650,cargo:1200,level:5,cost:{metal:4200,crystal:2600,tritium:1000}},
  battleship:{name:"Schlachtschiff",power:2400,cargo:3500,level:8,cost:{metal:16000,crystal:9000,tritium:4000}},
  destroyer:{name:"Zerstörer",power:7000,cargo:6000,level:10,cost:{metal:48000,crystal:32000,tritium:14000}}
};
